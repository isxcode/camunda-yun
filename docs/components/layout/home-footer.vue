<template>
  <div class="footer">
    ...
    <div class="content">
      <div class="left">
        <img class="logo-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/web-img/logo.jpg" alt=""/>
        <div class="logo-name">
          {{ $t("company_name") }}
        </div>
...
function clickGitee() {
  window.open("https://gitee.com/isxcode/camunda-yun");
}

function clickGithub() {
  window.open("https://github.com/isxcode/camunda-yun/discussions");
}
