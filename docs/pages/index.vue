    ...
    <div class="module-about">
      <div class="content">
        ...
        <div class="tech-img-div">
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-k8s.png" alt=""/>
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-hadoop.png" alt=""/>
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-spark.png" alt=""/>
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-hive.png" alt=""/>
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-doris.png" alt=""/>
          <img class="tech-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/it-img/t-clickhouse.png" alt=""/>
        </div>
      </div>
    </div>
...
.main {
  ...
  .module-intro {
    ...
    background-image: url("https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/web-img/bg-0.jpg");
    padding-top: 200px;
    position: relative;
    overflow: hidden;
  ...
  .module-business {
    ...
    background-position: center;
    background-repeat: no-repeat;
    background-image: url("https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/web-img/bg-2.jpg");
    display: flex;
    align-items: center;
    justify-content: center;
...
.module-end {
  ...
  background-position: center;
  background-repeat: no-repeat;
  background-image: url("https://isxcode.oss-cn-shanghai.aliyuncs.com/zhishuyun/website/web-img/bg-1.jpg");
  display: flex;
  align-items: center;
  justify-content: center;
